        ...
        <div class="row">
            <div class="col-sm-4 col-md-3 project-filters">
                <div class="filter-box">
                    ...
                    <h5>
                        These are the coding projects available, we are making a huge effort to include more projects every day.
                    </h5>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <ul class="step-text assignments">
                            <div class='loading'>
                                <svg version="1.1" id="loading-dots" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 512 512" xml:space="preserve">
