...
?>
    ...
    <div class="row">
        ...
        <article class="col-md-9 col-sm-9" role="main">
            <div class="row">
                <div class="col-md-12">
                    <h2><?php echo pll__( 'Assets related to' ); ?> <span class="label label-dark"><?php echo $args['term']->name; ?></span></h2>
					<ul class="list-view">
        ...
        <aside class="col-md-3 col-sm-3 sidebar">
            ...
            <ul class="grid-view view-col-12">
              <li>
                ...
                foreach ($technologies as $args['technology']) { ?>
                    <a href="<?php echo get_term_link($args['technology']); ?>" class="label label-default"><?php echo $args['technology']->name; ?></a>
                <?php } ?>
              </li>
              <li>
