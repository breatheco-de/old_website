...
var bulkbadges = function () {
    ...
    _createClass(bulkbadges, [{
        ...
        value: function init() {
            ...
            var studentsInputs = document.querySelectorAll('.studentsToAssign li input');
            if (studentsInputs && studentsInputs.length > 0) Array.from(studentsInputs).forEach(function (inputs) {
                inputs.addEventListener('input', function (e) {
                    var currentStudent = e.currentTarget.parentNode.parentNode;
