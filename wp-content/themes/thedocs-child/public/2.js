...
exports.BackgroundManager = undefined;

var _gsap = __webpack_require__(101);

var BackgroundManager = exports.BackgroundManager = function () {
    ...
    var width,
        ...
        target,
        animateHeader = true;
    var _headerId = 'large-header';
    var _canvasId = 'demo-canvas';
    var publicScope = {};

    // Main
    publicScope.init = function (headerId, canvasId) {
...
var lesson = function () {
    function lesson() {
        ...
        _background.BackgroundManager.init('large-header', 'demo-canvas');
