...
<html lang="en">
  ...
  <body <?php body_class(); ?>>
    ...
    <header class="site-header sticky navbar-fullwidth navbar-transparent">
      ...
      <!-- Banner -->
      <div class="banner banner-sm background-color1" >
        <div class="container text-center text-white">
          <br><br>
          <h1>
            <?php if(isset($redux_demo['header_text'])){?>
            <?php echo esc_attr($redux_demo['header_text']); ?>
            <?php }else{?>
            <?php echo esc_html__( 'Latest blog posts', 'thedocs' );
            }
            ?>
          </h1>
          <h5>
            <?php if(isset($redux_demo['header_subtext'])){?>
            <?php echo htmlspecialchars_decode(esc_attr($redux_demo['header_subtext'])); ?>
            <?php }else{?>
            <?php echo htmlspecialchars_decode(esc_html__( 'Read the <strong>latest news</strong> of the product right here.', 'thedocs' ));
            }
            ?>
