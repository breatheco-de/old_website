...
<html lang="en">
  ...
  <body <?php body_class(); ?>>
    ...
    <header class="site-header sticky navbar-fullwidth navbar-transparent">
      ...
      <!-- Banner -->
      <div class="banner banner-full-height has-attached-image background-color1" >
        <div class="container text-center text-white">
          <h1><?php echo esc_attr($redux_demo['header_ban3_text']);?></h1>
          <h5 class="text-uppercase"><?php echo esc_attr($redux_demo['header_ban1_destext']);?></h5>
        </div>
        <div class="attached-image">
        <?php if(isset($redux_demo['banner3']['url']) && $redux_demo['banner3']['url'] != ''){?>
          <img src="<?php echo esc_url($redux_demo['home_banner']['url']); ?>" alt="banner">
          <?php }else{?>
          <img src="<?php echo get_template_directory_uri();?>/assets/img/banner5.png" alt="banner">
        </div>
        <?php }?>
      </div>
      <!-- END Banner -->
