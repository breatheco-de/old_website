...
<html lang="en" <?php language_attributes(); ?>>
  ...
  <body <?php body_class(); ?>>
      <header class="site-header sticky navbar-fullwidth navbar-transparent">
          ...
          <!-- Banner -->
        <?php if(isset($redux_demo['home_banner']['url']) && $redux_demo['home_banner']['url'] != ''){?>
          <div class="banner banner-full-height overlay-black" style="background-image: url(<?php echo esc_url($redux_demo['home_banner']['url']); ?>);">
        <?php }else{?>
        ...
        <?php }?>     
            <div class="container text-center">
              <h1><?php echo esc_attr($redux_demo['header_home_text']);?></h1>
              <h5><?php echo htmlspecialchars_decode($redux_demo['header_home_subtext']);?></h5>
              <br><br><br><br>
              <p><a class="btn btn-white btn-xl btn-outline" href="#getting_started" role="button">
              <?php if(isset($redux_demo['getting_started'])){?>
                        <?php echo esc_attr($redux_demo['getting_started']); ?>
                        <?php }else{?>
                        <?php echo esc_html__( 'Getting started', 'thedocs' );
                        }
                        ?></a></p>
            </div>
