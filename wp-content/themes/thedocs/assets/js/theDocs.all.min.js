  ...
  $('.code-window').each(function(index, value){
    ...
    if ($(this).children().size() > 1) {
      ...
      $(this).children().each(function(index, value){
        ...
        topbar += '<label class="btn'+ active +'" '+((title=='') ? 'style="display:none;"':'')+'><input type="radio" autocomplete="off"'+ check +'>'+ title +'</label>';
      });
    ...
    {
      window_content.children(":visible").fadeOut(200, function() {
        let markedAsActive = window_content.children("pre.active")
        if(markedAsActive.length>0) markedAsActive.fadeIn(200);
        else window_content.children("pre:eq(0)").fadeIn(200);
      });
    }
  });
