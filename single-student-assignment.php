...
if (have_posts()){
    ...
    $thumbnail = get_the_post_thumbnail( $assignmentId, 'post_thumbnail', array( 'class' => 'alignleft' ) );
...
?>
    ...
    <div class="row">
        <!-- END Main content -->
        <!-- Sidebar -->
        <aside id="assignment-meta" class="col-md-5 col-sm-3">
			<div class="">
            	<h4>
            		<i class="fa fa-calendar" aria-hidden="true"></i> Due date:
            		<small><?php echo date('jS \of F: hA', $duedate); ?></small>
            	</h4> 
            </div>
            <table class="table table-striped table-changelog">
              <tbody>
                <tr>
                    <td>Technologies:</td>
                    <td>
                        <?php $technologies = wp_get_post_terms($assignmentId,'project-technology');
        ...
        <!-- Main content -->
        <article class="col-md-7 col-sm-9 main-content" role="main">
            <div class="row">
                <div class="col-md-12">
